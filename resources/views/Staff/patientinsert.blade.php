...
@section('staff')
    <div class="container p-5">
        <div class="row">
            <div class="col-12">
                <a href="{{ route('staff.patient') }}" class="btn btn-dark  ">
                ...
                <div class="card">
                    <div class="card-body">
                       <form action="{{ route('staff.store') }}" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input type="age" class="form-control" id="floatingInput" name="age"
                        ...
                        <input type="submit" value="Add Patient" class="btn btn-success w-100">
                       </form>
                    </div>
                </div>
            </div>
